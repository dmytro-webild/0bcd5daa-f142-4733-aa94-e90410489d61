...
export const metadata: Metadata = {
  title: "Hostel 26 Košice – Affordable Accommodation in Slovakia",  description: "Hostel 26 offers comfortable and affordable accommodation in Košice, Slovakia. Located near the city center with clean rooms, friendly staff, and convenient access to historic attractions.",  keywords: "Hostel Košice, Accommodation Košice, Cheap accommodation Slovakia, Stay in Košice, Budget hostel",  metadataBase: new URL("https://hostel26.sk"),
  alternates: {
    canonical: "https://hostel26.sk"
  },
  openGraph: {
    title: "Hostel 26 Košice – Your Perfect Stay",    description: "Comfortable, clean, and affordable accommodation near the heart of Košice",    url: "https://hostel26.sk",    siteName: "Hostel 26",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/pillow-bed_74190-6245.jpg",        alt: "Hostel 26 bedroom accommodation"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Hostel 26 Košice",    description: "Affordable hostel accommodation in Košice",    images: ["http://img.b2bpic.net/free-photo/pillow-bed_74190-6245.jpg"]
  },
  robots: {
    index: true,
    follow: true
